...
// Comprehensive curriculum and lesson translations (111+ entries)
const CURRICULUM_TEXT_EN = {
  "Niveau Débutant": "Beginner Level",
  "Débutant": "Beginner",
  "Intermédiaire": "Intermediate",
  "Avancé": "Advanced",
  "Module 1 : Les bases de la communication": "Module 1: Communication basics",
  "Module 2 : Le quotidien et l’entourage": "Module 2: Daily life and people around you",
  "Module 3 : Besoins immédiats": "Module 3: Immediate needs",
  "Les salutations et les formules de politesse": "Greetings and polite expressions",
  "Se présenter (nom, âge, origine, profession)": "Introducing yourself (name, age, origin, profession)",
  "L’alphabet et les sons spécifiques de la langue": "The alphabet and the language's specific sounds",
  "Salutations": "Greetings",
  "Se présenter": "Introducing yourself",
  "Alphabet / Sons": "Alphabet / Sounds",
  "Famille": "Family",
  "Chiffres / Nombres": "Digits / Numbers",
  "Jours / Heures": "Days / Times",
  "Distinguer et utiliser les salutations formelles et informelles en fonction du statut de l’interlocuteur": "Distinguish and use formal and informal greetings according to the listener's status",
  "Choisir la salutation appropriée selon le moment exact de la journée et de la soirée": "Choose the appropriate greeting for the exact time of day or evening",
  "Exprimer la gratitude, formuler des excuses de base et employer les rituels de politesse quotidiens": "Express gratitude, offer basic apologies, and use everyday politeness rituals",
  "Maîtriser la prise de congé selon l’imminence des retrouvailles": "Master farewells according to how soon you will meet again",
  "Les bases de la communication": "Communication basics",
  "Le quotidien et l’entourage": "Daily life and people around you",
  "Besoins immédiats": "Immediate needs",
  "Nuances et complexité": "Nuance and complexity",
  "Culture, traditions et rhétorique": "Culture, traditions, and rhetoric",
  "Maîtrise totale": "Complete mastery",
  "Exprimer ses idées et son environnement": "Expressing ideas and describing your surroundings",
  "Le temps et le récit": "Time and storytelling",
  "Interactions sociales et professionnelles": "Social and professional interactions",
  "Parler de sa maison, de son logement et de sa ville": "Talking about your home, housing, and city",
  "Les loisirs, les passions et les activités sportives": "Leisure, interests, and sports activities",
  "Exprimer ses goûts, ses préférences et ses sentiments": "Expressing tastes, preferences, and feelings",
  "Raconter des faits passés (les temps du récit)": "Telling about past events (narrative tenses)",
  "Parler de ses projets futurs et de ses ambitions": "Talking about future plans and ambitions",
  "Faire des achats, négocier les prix et gérer l’argent": "Shopping, negotiating prices, and managing money",
  "Exprimer l’obligation, l’interdiction et la permission": "Expressing obligation, prohibition, and permission",
  "Parler de son travail, de ses études et de sa routine professionnelle": "Talking about work, studies, and professional routines",
  "Demander et donner des conseils ou des instructions": "Asking for and giving advice or instructions",
  "La famille et les relations proches": "Family and close relationships",
  "Les chiffres, les nombres et le comptage": "Digits, numbers, and counting",
  "Les jours de la semaine, les mois et dire l’heure": "Days of the week, months, and telling the time",
  "Demander son chemin et se repérer (les directions)": "Asking for directions and finding your way",
  "La nourriture et les boissons (commander au marché ou au restaurant)": "Food and drinks (ordering at a market or restaurant)",
  "Les couleurs et les vêtements": "Colors and clothing",
  "Les proverbes, dictons et expressions imagées de la culture": "Cultural proverbs, sayings, and idiomatic expressions",
  "Débattre, argumenter et défendre un point de vue": "Debating, arguing, and defending a point of view",
  "Comprendre et analyser des textes littéraires ou historiques": "Understanding and analyzing literary or historical texts",
  "Le lexique technique, professionnel et spécialisé": "Technical, professional, and specialized vocabulary",
  "Traduction et nuances stylistiques avancées": "Translation and advanced stylistic nuances",
  ...
  "Savoir saluer selon le moment de la journée en espagnol": "Know how to greet according to the time of day in Spanish",
  "Exprimer la politesse, le remerciement et prendre congé de manière simple": "Express politeness, gratitude, and say goodbye simply",
  "(bonjour, merci, au revoir)": "(hello, thank you, goodbye)",
  "(bonjour, merci, au revoir).": "(hello, thank you, goodbye).",
  "en chinois mandarin": "in Mandarin Chinese",
  "(Version Enrichie)": "(Enhanced Version)",
  "Ce module est disponible dès le départ.": "This module is available from the start.",
  "Termine le module précédent et valide sa série d’exercices avec au moins 70%.": "Finish the previous module and pass its exercise set with at least 70%.",
  "Termine le module précédent pour débloquer ce module.": "Finish the previous module to unlock this module.",
  "Débloque ce niveau en terminant d’abord toutes les leçons et les séries d’exercices du Niveau Débutant avec une moyenne d’au moins 70%.": "Unlock this level by first completing all lessons and exercise sets in Beginner Level with an average of at least 70%.",
  "Maîtriser": "Master",
  "Exprimer": "Express",
  "Formuler": "Formulate",
...
export const getLocalizedCurriculumText = (value, locale = "fr") => {
  const text = String(value || "");
  if (locale !== "en") return text;

  return [...Object.entries(CURRICULUM_TEXT_EN)]
    .sort((a, b) => b[0].length - a[0].length)
    .reduce((localized, [source, translation]) => localized.replaceAll(source, translation), text);
};

export const getLanguageName = (language, locale = "fr") => {
  if (!language) return "";
  ...
  const code = language.code || (typeof language === "string" ? language : "");
  const translation = languageNameTranslations[locale]?.[code];
  
  if (translation) {
    return translation;
  }
  
  const name = language.name || language.name_fr || language.code || "";
  if (locale === "en") {
...
export const getLocalizedCountryForLanguage = (language, locale = "fr") => {
  const country = getCountryForLanguage(language);
  // Translation for common countries
  ...
  return countryTranslations[locale]?.[country] || country;
};
